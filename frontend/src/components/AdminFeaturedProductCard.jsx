...
import AdminFeaturedProductEdit from "./AdminFeaturedProductEdit";
const AdminFeaturedProductCard = ({ data, fetchData }) => {
...
export default AdminFeaturedProductCard;
