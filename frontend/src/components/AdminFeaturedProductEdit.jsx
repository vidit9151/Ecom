...
const AdminFeaturedProductEdit = ({ onClose, productData, fetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(summaryApi.updateFeaturedProduct.url, {
      method: summaryApi.updateFeaturedProduct.method,
      credentials: "include",
      headers: {
  ...
  const handleDelete = async () => {
    const response = await fetch(summaryApi.deleteFeaturedProduct.url, {
      method: summaryApi.deleteFeaturedProduct.method,
      credentials: "include",
      headers: {
        "content-type": "application/json",
      },
...
export default AdminFeaturedProductEdit;
